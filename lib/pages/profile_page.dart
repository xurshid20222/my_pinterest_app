...
import 'package:my_pinterest_app/services/auth_service.dart';
          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                const Text('${'Xurshid'} ${'Yusuvaliyev'}', style: TextStyle(fontSize: 30, color: Colors.white),),
                const SizedBox(height: 5,),
                const Text('xurshid@gmail.com', style: TextStyle(color: Colors.grey, fontSize: 16),),
              ],
            ),
            Visibility(
                visible: isLoading,
